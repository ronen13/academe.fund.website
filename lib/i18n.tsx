...
export const content: Record<Lang, Content> = {
  ...
  ar: {
    ...
    hero: {
      badge: "مطابقة شخصية للمنح الدراسية والمساعدات المالية",
      title: "الطريقة الذكية والشاملة",
      titleAccent: "لتمويل شهادتك",
      subtitle:
        "استبيان واحد يرسم لك خريطة بجميع المنح الدراسية ومنح المعيشة والمساعدات المالية في إسرائيل — بمطابقة شخصية دقيقة، وشفافية كاملة، وبدون أي تكلفة.",
      primaryCta: "ابدأ الاستبيان",
      secondaryCta: "كيف يعمل",
      note: "بدون تكلفة · بدون التزام · 4 دقائق",
      stats: [
        { value: "+240 مليون ₪", label: "منح دراسية بانتظار التوزيع" },
        { value: "+1,800", label: "مسار مساعدة في قاعدة البيانات" },
        { value: "92%", label: "وجدوا مطابقة مناسبة" },
      ],
    },
    trust: {
      heading: "نبني الثقة في كل خطوة",
      items: [
        "بياناتك مشفّرة وتبقى ملكًا لك",
        "رسم خرائط شامل قائم على البيانات",
        "شفافية كاملة في المعايير",
        "بدون رسوم خفية",
      ],
    },
    how: {
      heading: "ثلاث خطوات بسيطة",
      subheading: "بدون بيروقراطية غير ضرورية — فقط ما تحتاجه فعلاً لإيجاد المطابقة المناسبة لك.",
      steps: [
        {
          title: "املأ استبيانًا قصيرًا",
          body: "بضعة أسئلة حول مجال دراستك ووضعك المالي وأهدافك. يستغرق أقل من 4 دقائق.",
        },
        {
          title: "احصل على مطابقات شخصية",
          body: "يفحص نظامنا آلاف المسارات ويرتّب لك المنح الدراسية ذات الفرصة الأعلى.",
        },
        {
          title: "قدّم طلبك بثقة",
          body: "لكل منحة دراسية قائمة تحقّق مخصصة لك — ما هو مطلوب، ما هي الحالة، ومتى الموعد النهائي.",
        },
      ],
    },
    why: {
      heading: "لماذا يختار الطلاب AcadeMe.Fund",
      subheading: "لأن كل شخص يستحق فرصة عادلة للتعلّم — دون أن يضيع بين الأوراق.",
      items: [
        {
          title: "مطابقة دقيقة",
          body: "خوارزمية تفهم المعايير بعمق وترتّب حسب فرصتك الحقيقية.",
        },
        {
          title: "رسم خرائط شامل",
          body: "كل مصادر التمويل الممكنة في مكان واحد — منح دراسية، منح معيشة، ومساعدات مالية.",
        },
        {
          title: "شفافية كاملة",
          body: "اعرف بالضبط لماذا تمت مطابقتك مع كل منحة، وما هو المطلوب، وما هي فرصك.",
        },
        {
          title: "توفير وقت ثمين",
          body: "بدلاً من ساعات من البحث — قائمة مركّزة جاهزة للتقديم.",
        },
      ],
    },
    guidance: {
      badge: "مطابقة شخصية كاملة",
      heading: "كل مسارات التمويل الخاصة بك، في مكان واحد",
      body: "نرسم لك خريطة شاملة لجميع المنح الدراسية ومنح المعيشة والمساعدات المالية ذات الصلة — وتصبح المطابقة أكثر دقة كلما تعرّفنا عليك أكثر.",
      points: [
        "رسم خرائط ذكي لجميع مصادر التمويل في إسرائيل",
        "ترتيب حسب فرصتك الحقيقية",
        "تحديث تلقائي عند فتح مسارات جديدة",
        "واجهة واحدة بالعبرية والإنجليزية",
      ],
      cta: "اكتشف مطابقتك",
    },
    testimonials: {
      heading: "الطلاب يتحدثون",
      subheading: "آلاف الطلاب وجدوا بالفعل طريقهم نحو التمويل.",
      items: [
        {
          quote:
            "لم أكن أعلم أنني مؤهلة أصلاً للحصول على منح دراسية. خلال دقائق حصلت على قائمة مخصصة، وحصلت على اثنتين منها.",
          name: "مايا ل.",
          role: "طالبة هندسة، السنة الثانية",
        },
        {
          quote:
            "القائمة التي حصلت عليها كانت مطابقة تمامًا لوضعي. لم أُضيّع وقتي على منح غير ذات صلة بي.",
          name: "يوسف أ.",
          role: "طالب حقوق",
        },
        {
          quote:
            "وفّرت ساعات وساعات من البحث. كان كل شيء مركّزًا وواضحًا وبدون شروط خفية.",
          name: "نوعا ك.",
          role: "ماجستير في علم النفس",
        },
      ],
    },
    faq: {
      heading: "الأسئلة الشائعة",
      subheading: "كل ما يجب معرفته قبل البدء.",
      items: [
        {
          q: "هل الخدمة مجانية حقًا؟",
          a: "نعم. تعبئة الاستبيان والمطابقة والحصول على النتائج كلها مجانية وبدون أي التزام.",
        },
        {
          q: "ماذا يحدث لبياناتي؟",
          a: "يتم تشفير المعلومات وتُستخدم فقط لغرض المطابقة. لن نبيع أو نشارك بياناتك أبدًا.",
        },
        {
          q: "كم من الوقت يستغرق ملء الاستبيان؟",
          a: "ينهي معظم الطلاب الاستبيان خلال أقل من 4 دقائق. يمكنك أيضًا الحفظ والمتابعة لاحقًا.",
        },
        {
          q: "هل أنا ملزم بالتقديم للمنح التي تمت مطابقتها لي؟",
          a: "على الإطلاق لا. تحصل على توصيات وتختار بنفسك ما تريد التقديم له. القرار دائمًا لك.",
        },
      ],
    },
    finalCta: {
      heading: "منحتك الدراسية القادمة بانتظارك",
      body: "ابدأ الاستبيان الآن ودعنا نرسم لك خريطة بجميع خيارات التمويل حتى القبول.",
      button: "ابدأ الاستبيان",
      note: "بدون تكلفة · 4 دقائق · نتائج فورية",
    },
    footer: {
      tagline: "نرسم لكل طالب طريقه نحو التمويل الذي يستحقه.",
      rights: "جميع الحقوق محفوظة.",
      links: ["الخصوصية", "شروط الاستخدام", "تواصل معنا"],
    },
  },
}
